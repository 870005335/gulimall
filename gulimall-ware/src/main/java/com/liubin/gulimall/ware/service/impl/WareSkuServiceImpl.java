...
import com.liubin.gulimall.ware.feign.ProductFeignService;
...
import com.liubin.gulimall.ware.dao.WareSkuDao;
import com.liubin.gulimall.ware.entity.WareSkuEntity;
import com.liubin.gulimall.ware.service.WareSkuService;
...
public class WareSkuServiceImpl extends ServiceImpl<WareSkuDao, WareSkuEntity> implements WareSkuService {
    ...
    @Override
    public List<SkuStockDto> getSkusHasStock(List<Long> skuIds) {
        return skuIds.stream().map(skuId -> {
            SkuStockDto stockVo = new SkuStockDto();
            // 查询当前
